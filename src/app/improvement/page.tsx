  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header Summary */}
        <div className="bg-white/80 backdrop-blur rounded-2xl shadow-xl border border-blue-100 p-6 mb-8">
        ...
        <div className="space-y-4">
          {questionsData.map((question, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white/80 backdrop-blur rounded-2xl shadow-lg border border-gray-200 overflow-hidden transition-all duration-300 hover:shadow-xl"
              >
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                      <div
                        className={`inline-flex items-center px-4 py-2 rounded-xl text-lg font-bold shadow-sm ${
                          userAnswer >= 80
