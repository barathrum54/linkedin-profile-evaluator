...
- Name: Authentication Flow >> should navigate to forgot password page
- Location: /Users/minted_tr/Desktop/linkedin-profile-evaluator/e2e/auth.spec.ts:82:7
...
Locator: locator('h1')
Expected string: "Şifre Sıfırlama"
Received string: "Şifremi Unuttum"
Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('h1')
    9 × locator resolved to <h1 class="text-3xl font-bold text-gray-900 mb-2">Şifremi Unuttum</h1>
      - unexpected value "Şifremi Unuttum"

    at /Users/minted_tr/Desktop/linkedin-profile-evaluator/e2e/auth.spec.ts:87:38
```
...
```yaml
- img
- heading "Şifremi Unuttum" [level=1]
- paragraph: Email adresinizi girin, size şifre sıfırlama bağlantısı gönderelim
- text: Email Adresi
- textbox "Email Adresi"
- button "Şifre Sıfırlama Bağlantısı Gönder"
- link "← Giriş Sayfasına Dön":
  - /url: /auth/signin
- alert
