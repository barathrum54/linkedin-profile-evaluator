...
- Name: Authentication Flow >> should show error for weak password
- Location: /Users/minted_tr/Desktop/linkedin-profile-evaluator/e2e/auth.spec.ts:53:7
...
Call log:
  ...
  - waiting for locator('.text-red-700')
    ...
    at /Users/minted_tr/Desktop/linkedin-profile-evaluator/e2e/auth.spec.ts:64:49
```
...
```yaml
- img
- heading "Hesap Oluşturun" [level=1]
- paragraph: LinkedIn profil analizinizi başlatmak için hesap oluşturun
- button "LinkedIn ile Hesap Oluştur":
  - img
  - text: LinkedIn ile Hesap Oluştur
- button "Google ile Hesap Oluştur":
  - img
  - text: Google ile Hesap Oluştur
- button "GitHub ile Hesap Oluştur":
  - img
  - text: GitHub ile Hesap Oluştur
- text: veya email ile Ad Soyad
- textbox "Ad Soyad": Test User
- text: Email Adresi
- textbox "Email Adresi": test@example.com
- text: Şifre
- textbox "Şifre": "123"
- text: Şifre Tekrar
- textbox "Şifre Tekrar"
